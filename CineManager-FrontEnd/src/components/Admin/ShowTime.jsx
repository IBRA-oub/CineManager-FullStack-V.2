...
export default function ShowTime() {
    ...
    const sessionDataFunction = (async () => {
    ...
    const handleSubmit = async (e) => {
        ...
        const showTimeData = await creatSession(data);
        if (showTimeData) {
                            ...
                            <thead className='bg-[#e5e5e5] '>
                                <tr>
                                    <th className="border-y border-blue-gray-100 bg-blue-gray-50/50 p-4 ">
                                        <p className="block antialiased font-sans text-sm text-black  leading-none font-semibold">Date</p>
                                    </th>
                                    <th className="border-y border-blue-gray-100 bg-blue-gray-50/50 p-4">
                                        <p className="block antialiased font-sans text-sm text-black  leading-none font-semibold">Price/Seat</p>
                                    </th>
                                    <th className="border-y border-blue-gray-100 bg-blue-gray-50/50 p-4">
                                    ...
                                    <th className="border-y border-blue-gray-100 bg-blue-gray-50/50 p-4">
                                        <p className="block antialiased font-sans text-sm text-black  leading-none font-semibold">Salle</p>
                                    </th>
                                    <th className="border-y border-blue-gray-100 bg-blue-gray-50/50 p-4">
                                        <p className="block antialiased font-sans text-sm text-black  leading-none font-semibold">Film</p>
                                    </th>
                                    ...
                                    sessions.map((session) => {
                                        ...
                                        : 0;                                        return (
                                            <tr key={session._id}>
                                                ...
                                                <td className="p-4 border-b border-blue-gray-50">
                                                    <p className="block antialiased font-sans text-sm leading-normal text-blue-gray-900 font-normal">{session?.salle?.nom}</p>
                                                </td>
                                                <td className="p-4 border-b border-blue-gray-50">
                                                    <p className="block antialiased font-sans text-sm leading-normal text-blue-gray-900 font-normal">{session?.film?.titre}</p>
                                                </td>
                ...
                <div className='fixed top-0 left-0 w-full min-h-screen bg-[#00000069]'>
                    <div className='w-full h-screen flex items-center justify-center'>
                        <div className='w-1/3 bg-white p-6 rounded-md relative'>
                            ...
                            <h2 className='text-center font-bold mb-4'>Update Show Time</h2>
                                ...
                                <div className='mb-4'>
                                    ...
                                    >
                                        ...
                                        {films.map((film) => (
                                            ...
                                            <option value={film._id}>{film.titre}</option>
                                        ))}
                ...
                <div className='fixed top-0 left-0 w-full min-h-screen bg-[#00000069]'>
                    <div className='w-full h-screen flex items-center justify-center'>
                        <div className='w-1/3 bg-white p-6 rounded-md relative'>
                            ...
                            <h2 className='text-center font-bold mb-4'>Add Show Time</h2>
