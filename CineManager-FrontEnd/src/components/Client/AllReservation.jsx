...
export default function AllReservation() {
    ...
    useEffect(() => {
        ...
        const fetchReservation = async () => {
            const data = await getAllResrvation();
            console.log(data);
            setReservation(data);
        };
                        ...
                        <div key={reservation._id} className="relative mx-auto w-full">
                            ...
                            <div className="relative inline-block duration-300 ease-in-out transition-transform transform hover:-translate-y-2 w-full">
                                <div className="shadow p-4 rounded-lg bg-black text-white">
                                    <div className='w-full h-40 bg-white rounded-md bg-center bg-cover' style={{ backgroundImage: `url(${img})` }}>
                                    </div>

                                    <div className="mt-4">
                                        <h2 className="font-medium text-base md:text-lg text-gray-200 line-clamp-1" title="New York">
                                            {reservation.seance.film.titre}
                                        </h2>
                                        <p className="mt-2 text-sm text-gray-200 line-clamp-1" title="New York, NY 10004, United States">
                                            {reservation.seance.location}
                                        </p>
                                    </div>
                                    ...
                                    <div className="grid grid-cols-2 grid-rows-2 gap-4 mt-8">
                                        ...
                                        <p className="inline-flex flex-col xl:flex-row xl:items-center text-gray-200">
                                            ...
                                            <span className="mt-2 xl:mt-0">
                                                <span className='font-bold text-gray-400'>Time:</span>   {reservation.seance.date_heure}
                                            </span>
                                        </p>
                                        <p className="inline-flex flex-col xl:flex-row xl:items-center text-gray-200">
                                    ...
                                    <div className="grid grid-cols-1 mt-8">
                                        ...
                                        <div className="flex justify-end">
                                            <p className="inline-block font-semibold text-primary whitespace-nowrap leading-tight rounded-xl">
                                                ...
                                                <span className="text-lg text-yellow-500"> 300 </span> dh
                                            </p>
                                        </div>
                                    </div>
                                </div>
